...
We will use the gadgetron client and assume a profiles.config file is
already created and located in the root directory as described in
readme.  Gadgetron should be running on a network machine with IP
address and port listed in profiles.config.
...
if __name__ == '__main__':
    ...
    view(
        filename, fft=True, load_opts={'use':'rdi'},
        coil_combine_axis=-1, fft_axes=(0, 1))
