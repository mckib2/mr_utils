...
Notes
-----
Notice that df and phi_rf have similar, but different effects.
Off-resonance rotates that ellipse without moving the phase-cycle
points along the "race-track" while phi_rf both rotates and moves the
phase-cycle points.
'''
...
if __name__ == '__main__':
    ...
    # We want phase-cycles for a pixel with no offresonance, only
    # phi_rf effects and then equivalent phase-cycles for a pixel
    # with comparable off-resonance effects and no phi_rf phase.
