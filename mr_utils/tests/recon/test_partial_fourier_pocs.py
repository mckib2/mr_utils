...
class PartialFourerPOCSTestCase(unittest.TestCase):
    ...
    def test_partial_fourier_pocs(self):
        ...
        kspace[startRO:endRO:, startE1:endE1:] = kspace_all[
            startRO:endRO:, startE1:endE1:]

        # Run the POCS recon
        res_kspace = partial_fourier_pocs(
            kspace, startRO, endRO, startE1, endE1, niter=1000, thres=1e-8)
