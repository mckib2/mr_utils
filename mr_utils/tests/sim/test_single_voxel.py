...
from mr_utils.sim.single_voxel import combine_images
...
class SingleVoxelImagingTestCase(unittest.TestCase):
    ...
    def test_combine_images(self):
        ...
        _voxel_size = [10*im_size[ii]/dim for ii in range(len(im_size))]
        # print(voxel_size)
    ...
    def test_single_voxel_phantom_data(self):
        # from mr_utils.test_data import single_voxel_512, \
        #     single_voxel_256_0,single_voxel_256_1
