...
def dTV(A, eps=1e-8):
    ...
    References
    ----------
    .. [1] Zhang, Yan, Yuanyuan Wang, and Chen Zhang. "Total
           variation based gradient descent algorithm for sparse-view
           photoacoustic image reconstruction." Ultrasonics 52.8
           (2012): 1046-1055.
    '''

    # Note: I'm not sure np.roll is the thing to do as it's ambiguous
    # what happens on the edges of the update. Calling it good for
    # now though, as seems to be doing alright regardless.
