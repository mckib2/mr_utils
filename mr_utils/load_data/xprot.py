...
class XProtLex(object):
    # List of token names
    tokens = (
        'RANGLE','LANGLE','PERIOD','RBRACE','LBRACE','STRING','INTEGER',
        'FLOAT','HEX','SCINOT','XPROT','PMAP','PSTR','PLNG','PDBL','PBOOL',
        'PARRAY','PFUNCT','PCHOICE','PCARDLAYOUT','PIPE','PIPESERVICE','EVENT',
        'CONN','METHOD','DEPEND','PROTCOMP','NAME','EVASTRTAB','COMMENT',

        # modifiers
        'DEFAULT','CLASS','PRECISION','MINSIZE','MAXSIZE','LABEL','TOOLTIP',
        'LIMRANGE','LIMIT','REPR','POS','PARAM','CONTROL','LINE','DLL',
        'CONTEXT','ID','USERVERSION','INFILE','VISIBLE','COM','UNIT',

        # There are major divisions, we achieve this with modifiers
        'DICOM','MEAS','MEASYAPS','PHOENIX','SPICE',
